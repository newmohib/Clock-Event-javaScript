...
setToStore("decreaseSetTime", lastUpdateTime);
return lastUpdateTime;
}

var decreaseClock = function () {
    let getTime = getFromStore("decreaseSetTime");
    var hoursLimit;
    var minutesLimit;
    var secoundsLimit;
    if (getTime) {
    ...
    hoursLimit= hoursLimit <10?"0"+hoursLimit:hoursLimit
    minutesLimit= minutesLimit <10?"0"+minutesLimit:minutesLimit
    secoundsLimit=secoundsLimit <10?"0"+secoundsLimit:secoundsLimit
...
var decreaseStartClock = function (result) {
    setToStore("decreaseSetTime", result);
    decreaseClock();
...
var increaseTimeCalculation=function(getTime){
 ...
 setToStore("increaseStartClock", lastUpdateTime);
 return lastUpdateTime;
 }

var increaseClock = function () {
    let getTime = getFromStore("increaseStartClock");
    var hoursLimit;
    var minutesLimit;
    var secoundsLimit;
    if (getTime) {
...
var increaseStartClock = function (result) {
    setToStore("increaseStartClock", result);
    increaseClock();
