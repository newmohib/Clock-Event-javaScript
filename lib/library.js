...
var increaseClock = function () {
    ...
    if (isStart == true && hoursLimit < 24) {
        setTimeout("increaseClock()", 1000);
    } else {
    myclock.innerHTML = hoursLimit + ":" + minutesLimit + ":" + secoundsLimit + "  Time Out";
...
var decreaseClock = function () {
    ...
    if (isStart == false || hoursLimit == 0 && minutesLimit == 0 && secoundsLimit == 0) {
    myclock.innerHTML = hoursLimit + ":" + minutesLimit + ":" + secoundsLimit + "  Time Out";
